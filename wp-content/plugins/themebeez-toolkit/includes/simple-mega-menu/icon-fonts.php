<?php
/**
 * Icon fonts related functions for icon selection custom menu item field.
 *
 * @since 1.1.5
 *
...
if ( ! function_exists( 'simple_mega_menu_fontawesome_icons_list' ) ) {
	/**
	 * AJAX callback function form 'simple_mega_menu_fontawesome_icons_list_action'.
	 *
	 * @since 1.1.5
	 */
